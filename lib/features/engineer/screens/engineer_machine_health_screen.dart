...
class EngineerMachineHealthScreen extends StatefulWidget {
  const EngineerMachineHealthScreen({super.key});
  @override
  State<EngineerMachineHealthScreen> createState() =>
      _EngineerMachineHealthScreenState();
}

class _EngineerMachineHealthScreenState
    extends State<EngineerMachineHealthScreen>
          ...
          child: Directionality(
            ...
            child: SingleChildScrollView(
              child: Column(mainAxisSize: MainAxisSize.min, children: [
                ...
                _ddRow(ctx, 'حالة الزيت', _oilLevels, oilLevel,
                    (v) => ss(() => oilLevel = v!)),
                const SizedBox(height: 8),
                _ddRow(ctx, 'الحالة العامة', _conditions, condition,
                    (v) => ss(() => condition = v!)),
                const SizedBox(height: 8),
                TextField(
                  controller: tempCtrl,
                  keyboardType: const TextInputType.numberWithOptions(decimal: true),
                  decoration: _dec('درجة الحرارة (°C)'),
                  textDirection: TextDirection.rtl,
                ),
                const SizedBox(height: 8),
                TextField(
  ...
  Widget _ddRow(BuildContext ctx, String label, Map<String, String> opts,
                              ...
                              children: [
                                ...
                                Row(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      _oilLevels[r['oilLevel']] ?? r['oilLevel'] ?? '--',
                                      style: AppText.caption.copyWith(color: oColor),
                                      textDirection: TextDirection.rtl,
                                    ),
                                    if (r['temperature'] != null) ...[
                                      const SizedBox(width: 12),
                                      Text('الحرارة: ', style: AppText.caption),
    ...
    return SingleChildScrollView(
      ...
      child: Directionality(
        ...
        child: Column(children: [
          ...
          const SizedBox(height: 12),
          _ddFormRow('حالة الزيت', _oilLevels, _fOilLevel,
              (v) => setState(() => _fOilLevel = v!)),
          const SizedBox(height: 12),
          _ddFormRow('الحالة العامة', _conditions, _fCondition,
              (v) => setState(() => _fCondition = v!)),
          const SizedBox(height: 12),
          _ddFormRow('مستوى الاهتزاز', _levels, _fVibration,
              (v) => setState(() => _fVibration = v!)),
          const SizedBox(height: 12),
          _ddFormRow('مستوى الضوضاء', _levels, _fNoise,
          ...
          TextField(
            ...
            decoration: InputDecoration(
              labelText: 'درجة الحرارة °C (اختياري)',
  ...
  Widget _ddFormRow(String label, Map<String, String> opts, String value,
